...
<div class="row">
    <div class="col-md-6">
        <h1>Kontaktinfo</h1>
        <p>OÜ Atomic AD <br/> Tondi 1, Tallinn <br/> Harjumaa 11313 <br/></p>
        <br/>
        <p>tel +372 6418 495</p>
        <p>atomic@atomic.ee <br/> andrus@atomic.ee</p>
    </div>
    ...
    <div class="col-md-6">
        ...
        <form role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputText" placeholder="Sinu sõnum..." style="min-height:100px">
            </div>
